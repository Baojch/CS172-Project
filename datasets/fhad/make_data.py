...
def load_objects(obj_root):
    ...
    for obj_name in object_names:
        ...
        if not os.path.isfile(obj_path):
            raise ValueError(f"File does not exist: {obj_path}")
...
# Change this path
root = r"D:\bjc\skd\CS172\First-Person Hand Action Benchmark (F-PHAB)"
print(os.path.abspath(os.path.join(root, 'Hand_pose_annotation_v1')))
...
np.save('./datanpy/images-train.npy', np.array(images_train))
np.save('./datanpy/points2d-train.npy', np.array(points2d_train))
np.save('./datanpy/points3d-train.npy', np.array(points3d_train))

np.save('./datanpy/images-val.npy', np.array(images_val))
np.save('./datanpy/points2d-val.npy', np.array(points2d_val))
np.save('./datanpy/points3d-val.npy', np.array(points3d_val))

np.save('./datanpy/images-test.npy', np.array(images_test))
np.save('./datanpy/points2d-test.npy', np.array(points2d_test))
np.save('./datanpy/points3d-test.npy', np.array(points3d_test))